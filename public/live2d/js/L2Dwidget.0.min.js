...
webpackJsonpL2Dwidget([0], {
    131: function(t, i, e) {
        ...
        function v(t) {
            var i = t.touches[0];
            "touchstart" == t.type ? 1 == t.touches.length && T(i) : "touchmove" == t.type ?
                function(t) {
                    var i = o.currCanvas.getBoundingClientRect(),
                        e = E(t.clientX - i.left),
                        r = A(t.clientY - i.top),
    ...
    133: function(t, i, e) {
        ...
        c.load = function(t) {
            ...
            for (n = 0; n < i.length; n++) {
                if (!((s = i[n].partsIndex) < 0)) if (r == n) t.setPartsOpacity(s, o);
                else {
    ...
    135: function(t, i, e) {
        ...
        i.createElement = function() {
            ...
            e.id = o.config.name.div, e.innerHTML = s.
                default;
